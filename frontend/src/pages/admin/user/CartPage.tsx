        ...
        {items.length === 0 ? (
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                      ...
                      <div className="w-full md:w-1/2 flex mb-4 md:mb-0">
                        ...
                        <div className="ml-4">
                          <Link
                            ...
                            className="font-sans text-gray-800 hover:text-amber-700"
                          >
                            {item.product.name}
                          </Link>
            ...
            <div className="lg:w-1/3">
              <div className="bg-white rounded-lg shadow-sm p-6">
                <h2 className="text-xl font-sans mb-4">Tóm tắt đơn hàng</h2>
                <div className="space-y-3 mb-4">
                  <div className="flex justify-between">
                    <span className="font-sans text-gray-600">Tổng phụ</span>
                    <span>${subtotal.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="font-sans text-gray-600">Vận chuyển</span>
