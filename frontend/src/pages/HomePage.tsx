      ...
      <section className="relative py-20 md:py-32">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-xl mx-auto text-center text-white">
            <h2 className="font-serif text-3xl md:text-4xl font-medium mb-4">Transform Your Dining Experience</h2>
            <p className="text-lg opacity-90 mb-8">
              Explore our collection of dining tables, chairs, and accessories designed to create memorable dining moments.
            </p>
            <Link to="/products/tables">
              <Button size="lg">Shop Dining Furniture</Button>
            </Link>
          </div>
        </div>
      </section>
