    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <Link
            to="/"
            className="font-serif text-2xl font-bold tracking-tight text-slate-800"
          >
            Eco Decore
          </Link>
      ...
      >
        <div className="py-4">
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-3 mb-6 pb-4 border-b border-gray-100">
                ...
                <div>
                  ...
                  <Link to="/account" className="text-sm text-amber-700">
                    Xem tài khoản
                  </Link>
                </div>
              </div>
          ...
          <div className="px-4 pt-4 mt-2 border-t border-gray-100">
            {isAuthenticated && (
              <button className="block w-full py-2 text-center text-rose-600 hover:text-rose-700">
                Đăng xuất
              </button>
            )}
          </div>
