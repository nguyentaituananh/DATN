    ...
    <footer className="bg-gray-100 dark:bg-gray-900 pt-16 pb-6">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="font-serif text-2xl font-bold tracking-tight text-slate-800 ">Eco Decore</h3>
            <p className="text-gray-600 mb-4 max-w-xs  ">
              Kiến tạo không gian sống đẳng cấp với nội thất cao cấp từ năm 2010.
            </p>
            <div className="flex space-x-4 ">
              <a href="#" className="text-gray-600 hover:text-amber-400 transition-colors ">
                <Facebook size={20} />
              </a>
              <a href="#" className="text-gray-600 hover:text-amber-400 transition-colors">
                <Instagram size={20} />
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-600 hover:text-amber-400 transition-colors">
                  Tất cả sản phẩm
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/contact" className="text-gray-600 hover:text-amber-400 transition-colors">
                  Liên hệ
                </Link>
              </li>
              <li>
                <Link to="/shipping" className="text-gray-600 hover:text-amber-400 transition-colors">
                  Vận chuyển & Giao hàng
                </Link>
              </li>
              <li>
                <Link to="/returns" className="text-gray-600 hover:text-amber-400 transition-colors">
                  Đổi trả & Hoàn tiền
                </Link>
              </li>
              <li>
                <Link to="/faq" className="text-gray-600 hover:text-amber-400 transition-colors">
                  Câu hỏi thường gặp
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-gray-600 hover:text-amber-400 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-600">123 Đường Nội Thất, Quận 1, TP.HCM</span>
              </li>
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-600">info@luxefurnish.com</span>
              </li>
            </ul>
          </div>
        </div>
