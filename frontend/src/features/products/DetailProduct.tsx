...
import { ShoppingCart, Heart, Share2, Minus, Plus, Shield, Truck, RefreshCw, Star, ArrowLeft, AlertCircle } from 'lucide-react'
...
const DetailProduct = () => {
  ...
  // Set default selected image when product data loads
  useState(() => {
              ...
              <div className="relative group">
                ...
                {isOutOfStock && (
                  <div className="absolute inset-0 bg-black/20 backdrop-blur-sm rounded-xl flex items-center justify-center">
                    <span className="bg-white px-4 py-2 rounded-lg text-gray-800 font-semibold">
                      Hết hàng
                    </span>
                  </div>
                )}
                ...
                <div className="flex space-x-3 overflow-x-auto p-2">
                  {product.images.map((img, idx) => (
                    <img
                      ...
                      className={`flex-shrink-0 w-20 h-20 object-cover rounded-lg cursor-pointer transition-all ${selectedImage === img
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex space-x-4">
                  <button
                    className={`flex-1 py-4 px-6 rounded-xl font-bold text-lg transition-all transform ${isOutOfStock
                  ...
                  <button
                    ...
                    className={`flex-1 py-4 px-6 rounded-xl font-bold text-lg transition-all flex items-center justify-center space-x-2 ${isOutOfStock
          ...
          <div className="border-t border-gray-200 p-8">
            <div className="max-w-4xl">
              ...
              <div className="flex space-x-8 border-b border-gray-200 mb-6">
                <button
                  className={`pb-4 px-2 font-semibold text-lg transition-colors relative ${tab === 'details'
                ...
                <button
                  className={`pb-4 px-2 font-semibold text-lg transition-colors relative ${tab === 'warranty'
                    ? 'text-orange-600 border-b-2 border-orange-600'
                    : 'text-gray-500 hover:text-gray-700'
                    }`}
