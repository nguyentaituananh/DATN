...
const DashboardLayout = ({ children }: PropsWithChildren) => {
	...
	return (
		<SidebarProvider>
			<AppSidebar />
			<SidebarInset>
				<header className="bg-background sticky top-0 flex items-center h-16 shrink-0 justify-between border-b pl-4 pr-6 z-50 overflow-hidden">
				...
				<div className="p-6 flex-1 z-30">{children}</div>
			</SidebarInset>
		</SidebarProvider>
	)
}
